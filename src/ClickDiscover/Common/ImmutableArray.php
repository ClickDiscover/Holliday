...
class ImmutableArray extends SplFixedArray implements Countable, Iterator, ArrayAccess
{
    ...
    {
        throw new CantModifyImmutables(get_called_class() . " trying to modify index $offset. Wtf?");
    }
